<template>
    <Indexnav2 />
        ...
        <v-container>
          <h1 class="mb-12 mt-12 pl-6"><span class="text-green font-weight-bold text-h3">C</span>andidate for President</h1>
            <div class="container d-flex ga-10 px-4">
              ...
              >
                ...
                <v-card class="mt-4 border-t-md">
                  <div class="d-flex flex-column ga-4 px-12 py-4">
                    <!-- <v-btn variant="tonal" class="text-green">VOTE <v-icon icon="mdi-check-circle" end></v-icon></v-btn> -->
                    <v-btn variant="tonal" class="text-green">LEARN MORE <v-icon icon="mdi-help-circle-outline" end></v-icon></v-btn>
                  </div>
                </v-card>
              </v-card>
